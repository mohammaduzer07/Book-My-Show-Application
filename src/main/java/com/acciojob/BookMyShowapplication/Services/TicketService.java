...
public class TicketService {
    ...
    public String bookTicket(AddBookTicketRequest bookTicketRequest) throws Exception{
        Show show = showRepository.findById(bookTicketRequest.getShowId()).get();

        //check weather the seats available or not
    ...
    public ShowTicketResponse viewTicket(Integer ticketId){
        ...
        simpleMailMessage.setFrom("uzer.infinitecoder@gmail.com");
